                ...
                <div class='card-header p-0 position-relative mt-n4 mx-3 z-index-2'>
                    <div class='bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3'>
                        <div class='d-flex justify-content-between align-items-center'>
                            ...
                            <button class='btn btn-warning' style='margin-right:50px !important;' data-toggle='modal' data-target='#addSubCriteriaModal_{$criteria['id']}'>
                                Tambah Sub Kriteria
                            </button>
                        </div>
                    </div>
            ...
            while ($sub = $sub_criteria_result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td class='text-center'>
                            <button class='btn btn-info btn-sm' data-toggle='modal' data-target='#editSubCriteriaModal_{$sub['id']}'>
                                Edit
                            </button>
                            <a href='delete_sub_criteria.php?id={$sub['id']}' class='btn btn-danger btn-sm' onclick=\"return confirm('Apakah Anda yakin ingin menghapus sub kriteria ini?');\">
                                Hapus
                            </a>
                        </td>
                      </tr>";
