...
// Proses penyimpanan kriteria utama
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['criteria_name'])) {
    $criteria_name = $_POST['criteria_name'];
    $sql = "INSERT INTO criteria (name) VALUES ('$criteria_name')";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['sub_criteria_name'])) {
    $criteria_id = $_POST['criteria_id'];
    $sub_criteria_name = $_POST['sub_criteria_name'];
    $sub_criteria_value = $_POST['sub_criteria_value'];
    $sql = "INSERT INTO sub_criteria (criteria_id, name, value) VALUES ('$criteria_id', '$sub_criteria_name', '$sub_criteria_value')";
    if ($conn->query($sql) === TRUE) {
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../pages/pengaturan.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
